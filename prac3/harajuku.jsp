            ...
            <div id="content">
                ...
                <div id="restaurants">
                    <h2>Info</h2>
                        <div class="info">
                            <h3>Address</h3>
                                <p>69 Station Road, Indooroopilly QLD</p>
                            <h3>Phone</h3>
                                <p>(07) 3878 1566</p>
                            <h3>Opening Hours</h3>
                                <p>Open 24/7!</p>
                            <h3>Menu </h3>
                                ...
                                <a href="../img/pracs/res/menus/harajuku1.jpg" target="_blank">
                                    <img alt="Menu" src="../img/pracs/res/menus/harajuku1.jpg" width="250">
                                </a>
                        </div>
